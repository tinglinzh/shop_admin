  ...
  <div v-loading="loading" class="bg-white p-4 rounded">
    <el-form :model="form" label-width="160px">
      <el-tabs v-model="activeName">
        <el-tab-pane class="mt-3" label="注册与访问" name="frist">
          ...
          <el-form-item label="强制密码复杂度">
            <el-checkbox-group v-model="form.password_encrypt">
              <el-checkbox border label="0">数字</el-checkbox>
              <el-checkbox border label="1">小写字母</el-checkbox>
              <el-checkbox border label="2">大写字母</el-checkbox>
              <el-checkbox border label="3">符号</el-checkbox>
            </el-checkbox-group>
          </el-form-item>
        </el-tab-pane>
