  ...
  >
    <div class="info_body">
      <el-card shadow="never" class="mb-3">
        ...
        <el-form label-width="80px">
          ...
          <el-form-item label="付款方式:">
            {{ info.payment_method }}</el-form-item
          >
      ...
      <el-card v-if="info.ship_data" shadow="never" class="mb-3">
        ...
        <el-form label-width="80px">
          <el-form-item label="物流公司:">
            {{ info.ship_data.express_company }}</el-form-item
          >
      ...
      <el-card shadow="never" class="mb-3">
        ...
        <div class="flex mb-2" v-for="(item, id) in info.order_items" :key="id">
          <el-image
      ...
      <el-card shadow="never" v-if="info.address" class="mb-3">
        ...
        <el-form label-width="80px">
          ...
          <el-form-item label="联系方式:">
            {{ info.address.phone }}</el-form-item
          >
      ...
      >
        <template #header>
          ...
          <el-button text disabled style="float: right">
            {{ refund_status }}</el-button
          >
        </template>
        <el-form label-width="80px">
          <el-form-item label="退款理由:">
            {{ info.extra.refund_reason }}</el-form-item
          >
        </el-form>
      </el-card>
    </div>
