      ...
      >
        ...
        >
          ...
          <el-form-item label="最低售价" prop="min_price">
            ...
            ></el-form-item
          >
          <el-form-item label="最低原件" prop="min_oprice">
            <el-input
...
getCategorysList().then((res) => {
  category_list.value = res;
});

// 设置轮播图
const bannersRef = ref(null);
const openBanners = (row) => {
  bannersRef.value.openDialog(row);
};
